...
public class Tabuleiro extends JPanel {
    ...
    private static ElementoBasico[][] celulas;
    ...
    public static  boolean posicaoValida(int lin, int col) {
        if ((lin < 0) || (col < 0) ||
    ...
    public static ElementoBasico removeElemento(ElementoBasico elemento) {
        int lin = elemento.getLin();
        int col = elemento.getCol();
            ElementoBasico elementoAnterior = celulas[lin][col];
